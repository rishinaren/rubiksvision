      ...
      <body>
        <header className="container" style={{ marginBottom: 12 }}>
          ...
          <p className="small" style={{ maxWidth: 800 }}>
            No sign-in. No uploads. We read colors locally in your browser, then animate a step-by-step solve.
            Works for <b>2×2</b> and <b>3×3</b>. Good indoor lighting helps.
          </p>
          <ol className="small" style={{ marginTop: 8, maxWidth: 800 }}>
            <li>Choose cube size.</li>
            <li>Use your camera to capture each face in order (U, R, F, D, L, B).</li>
            <li>Fix any misread stickers, confirm each face, then click <b>Solve</b>.</li>
